...
public class ColorPicker extends View {
	 ...
	 */
	private int mColorWheelThicknessOrigin;
	...
	private ThicknessBar mThicknessBar = null;
	/**
	...
	private void init(AttributeSet attrs, int defStyle) {
		...
		mColorWheelThicknessOrigin = a.getDimensionPixelSize(
				R.styleable.ColorPicker_color_wheel_thickness,
				b.getDimensionPixelSize(R.dimen.color_wheel_thickness));
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mColorWheelRadius = min / 2 - mColorWheelThicknessOrigin - mColorPointerHaloRadius;
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			if (mUserIsMovingPointer) {
				...
				if(mThicknessBar != null)
				{  
					mThicknessBar.setThickness(mColorWheelThickness);
					mThicknessBar.setColor(mColor);
				}
	...
	public void addThicknessBar(ThicknessBar bar)
	{
		mThicknessBar = bar;
		mThicknessBar.setColorPicker(this);
		mThicknessBar.setThickness(mColorWheelThickness);
		mThicknessBar.setColor(mColor);
	}
	/**
	...
	{
		setNewWheelThickness(pThickness);
		if(mThicknessBar != null)
		{
			mThicknessBar.setThickness(pThickness);
		}
	}
	
	public void setNewWheelThickness(int pThickness)
	{
		mColorWheelThickness = pThickness;
		mColorWheelPaint.setStrokeWidth(mColorWheelThickness);
		invalidate();
	}
