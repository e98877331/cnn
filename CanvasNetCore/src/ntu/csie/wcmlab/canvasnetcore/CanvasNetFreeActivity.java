...
public class CanvasNetFreeActivity extends RatioActivity {
		...
		getMainLayout().addView(titleView,
		 ...
		 titleView.setOnTouchListener(new OnTouchListener() {
				...
				public boolean onTouch(View v, MotionEvent event) {
					// TODO Auto-generated method stub
			        Animation ani2 = AnimationUtils.loadAnimation(CanvasNetFreeActivity.this, R.anim.title_canvasnet_anim_onclick);
	...
	private void onClickHost()
	{
		...
		intent.setClass(CanvasNetFreeActivity.this, MyCanvas.class);
	...
	private void openQRCodeDialog()
	{
		...
		LayoutInflater inflater = LayoutInflater.from(CanvasNetFreeActivity.this);  
        final View textEntryView = inflater.inflate(R.layout.qrcode_dialog, null);  
        final ProgressDialog.Builder dialog = new ProgressDialog.Builder(CanvasNetFreeActivity.this); 
